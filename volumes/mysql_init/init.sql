...
CREATE DATABASE IF NOT EXISTS db_im_samlConnect;
...
GRANT CREATE, ALTER, INDEX, LOCK TABLES, REFERENCES, UPDATE, DELETE, DROP, SELECT, INSERT ON `db_im_samlConnect`.* TO 'root'@'%';
